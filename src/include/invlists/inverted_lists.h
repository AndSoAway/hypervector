...
#ifndef HYPERVEC_INVERTEDLISTS_IVF_H
#define HYPERVEC_INVERTEDLISTS_IVF_H
...
struct InvertedLists {
  ...
  virtual bool is_empty(size_t list_no,
  ...
  virtual InvertedListsIterator* get_iterator(
    size_t list_no, void* inverted_list_context = nullptr) const;
  ...
  void MergeFrom(InvertedLists* oivf, size_t add_id);
...
#endif  // HYPERVEC_INVERTEDLISTS_IVF_H
