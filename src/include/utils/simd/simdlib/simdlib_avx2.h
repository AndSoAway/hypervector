...
inline simd16uint16_tpl<SIMDLevel::AVX2> min(
  simd16uint16_tpl<SIMDLevel::AVX2> a, simd16uint16_tpl<SIMDLevel::AVX2> b) {
...
inline uint32_t cmp_ge32(simd16uint16_tpl<SIMDLevel::AVX2> d0,
...
inline uint32_t cmp_le32(simd16uint16_tpl<SIMDLevel::AVX2> d0,
                         simd16uint16_tpl<SIMDLevel::AVX2> d1,
                         simd16uint16_tpl<SIMDLevel::AVX2> thr) {
...
inline void cmplt_min_max_fast(
  ...
  minIndices.i =
    _mm256_blendv_epi8(candidateIndices.i, currentIndices.i, comparison);
  maxValues.i = _mm256_max_epi16(candidateValues.i, currentValues.i);
  maxIndices.i =
    _mm256_blendv_epi8(currentIndices.i, candidateIndices.i, comparison);
}
...
struct simd32uint8_tpl<SIMDLevel::AVX2> : simd256bit_tpl<SIMDLevel::AVX2> {
  ...
  static simd32uint8_tpl create() {
    return simd32uint8_tpl(_mm256_setr_epi8(
      (char)_0, (char)_1, (char)_2, (char)_3, (char)_4, (char)_5, (char)_6,
      (char)_7, (char)_8, (char)_9, (char)_10, (char)_11, (char)_12, (char)_13,
      (char)_14, (char)_15, (char)_16, (char)_17, (char)_18, (char)_19,
      (char)_20, (char)_21, (char)_22, (char)_23, (char)_24, (char)_25,
      (char)_26, (char)_27, (char)_28, (char)_29, (char)_30, (char)_31));
  }
...
inline simd32uint8_tpl<SIMDLevel::AVX2> blendv(
  simd32uint8_tpl<SIMDLevel::AVX2> a, simd32uint8_tpl<SIMDLevel::AVX2> b,
  simd32uint8_tpl<SIMDLevel::AVX2> mask) {
  return simd32uint8_tpl<SIMDLevel::AVX2>(_mm256_blendv_epi8(a.i, b.i, mask.i));
}
...
inline void cmplt_min_max_fast(
  ...
  minIndices.i = _mm256_castps_si256(_mm256_blendv_ps(
    ...
    _mm256_castsi256_ps(currentIndices.i), _mm256_castsi256_ps(comparison)));
  ...
  maxIndices.i = _mm256_castps_si256(_mm256_blendv_ps(
    ...
    _mm256_castsi256_ps(candidateIndices.i), _mm256_castsi256_ps(comparison)));
}
...
inline simd8float32_tpl<SIMDLevel::AVX2> hadd(
  simd8float32_tpl<SIMDLevel::AVX2> a, simd8float32_tpl<SIMDLevel::AVX2> b) {
...
inline void cmplt_and_blend_inplace(
  ...
  lowestIndices.i = _mm256_castps_si256(
    _mm256_blendv_ps(_mm256_castsi256_ps(candidateIndices.i),
                     _mm256_castsi256_ps(lowestIndices.i), comparison));
}
...
inline void cmplt_min_max_fast(
  ...
  minIndices.i = _mm256_castps_si256(
    _mm256_blendv_ps(_mm256_castsi256_ps(candidateIndices.i),
                     _mm256_castsi256_ps(currentIndices.i), comparison));
  maxValues.f = _mm256_max_ps(candidateValues.f, currentValues.f);
  maxIndices.i = _mm256_castps_si256(
    _mm256_blendv_ps(_mm256_castsi256_ps(currentIndices.i),
                     _mm256_castsi256_ps(candidateIndices.i), comparison));
}
...
inline float horizontal_add(const simd8float32_tpl<SIMDLevel::AVX2>& a) {
  __m128 sum =
    _mm_add_ps(_mm256_castps256_ps128(a.f), _mm256_extractf128_ps(a.f, 1));
