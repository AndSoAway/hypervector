...
struct simd512bit_tpl<SIMDLevel::AVX512> {
  ...
  explicit simd512bit_tpl(simd256bit_tpl<SIMDLevel::AVX2> lo)
    : simd512bit_tpl(_mm512_inserti32x8(_mm512_castsi256_si512(lo.i),
  ...
  explicit simd512bit_tpl(simd256bit_tpl<SIMDLevel::AVX2> lo,
    ...
    : simd512bit_tpl(
        _mm512_inserti32x8(_mm512_castsi256_si512(lo.i), hi.i, 1)) {}
...
struct simd32uint16_tpl<SIMDLevel::AVX512> : simd512bit_tpl<SIMDLevel::AVX512> {
  ...
  explicit simd32uint16_tpl(__m512i i) : simd512bit_tpl<SIMDLevel::AVX512>(i) {}
  ...
  simd16uint16_tpl<SIMDLevel::AVX2> high() const {
    return simd16uint16_tpl<SIMDLevel::AVX2>(_mm512_extracti32x8_epi32(i, 1));
  }
...
struct simd64uint8_tpl<SIMDLevel::AVX512> : simd512bit_tpl<SIMDLevel::AVX512> {
  ...
  explicit simd64uint8_tpl(__m512i i) : simd512bit_tpl<SIMDLevel::AVX512>(i) {}
...
struct simd16float32_tpl<SIMDLevel::AVX512>
  ...
  explicit simd16float32_tpl(__m512 f) : simd512bit_tpl<SIMDLevel::AVX512>(f) {}
