...
static inline void bin(const S& simd, char bits[257]) {
  static_assert(std::is_same<void (S::*)(T*) const, decltype(&S::store)>::value,
                "invalid T");
  T ds[N];
  simd.store(ds);
  char bytes[32];
...
template <typename T>
static inline unary_func_impl<remove_cv_ref_t<T>, remove_cv_ref_t<T>>
unary_func(const T& a) {
  return {a};
}

template <typename T, typename U>
static inline unary_func_impl<remove_cv_ref_t<T>, remove_cv_ref_t<U>>
unary_func(const U& a) {
  return {a};
}
...
static inline uint32_t cmp_xe32(const uint16x8x2_t& d0, const uint16x8x2_t& d1,
  ...
  const auto d0_mask =
    vmovmask_u8(vmovn_high_u16(vmovn_u16(d0_thr.val[0]), d0_thr.val[1]));
  const auto d1_mask =
    vmovmask_u8(vmovn_high_u16(vmovn_u16(d1_thr.val[0]), d1_thr.val[1]));
...
struct simd16uint16_tpl<SIMDLevel::ARM_NEON> {
  ...
  explicit simd16uint16_tpl(uint16_t u0, uint16_t u1, uint16_t u2, uint16_t u3,
                            uint16_t u4, uint16_t u5, uint16_t u6, uint16_t u7,
                            uint16_t u8, uint16_t u9, uint16_t u10,
                            uint16_t u11, uint16_t u12, uint16_t u13,
                            uint16_t u14, uint16_t u15) {
    uint16_t temp[16] = {u0, u1, u2,  u3,  u4,  u5,  u6,  u7,
  ...
  template <typename T,
            typename std::enable_if<detail::simdlib::is_simd256bit<T>::value,
  ...
  simd16uint16_tpl operator*(const simd16uint16_tpl& other) const {
    return simd16uint16_tpl{
      detail::simdlib::binary_func(data, other.data).call<&vmulq_u16>()};
  }
  ...
  simd16uint16_tpl operator>>(const int shift) const {
    switch (shift) {
      ...
      case 1:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshrq<1>>()};
      case 2:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshrq<2>>()};
      case 3:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshrq<3>>()};
      case 4:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshrq<4>>()};
      case 5:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshrq<5>>()};
      case 6:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshrq<6>>()};
      case 7:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshrq<7>>()};
      case 8:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshrq<8>>()};
      case 9:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshrq<9>>()};
      case 10:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshrq<10>>()};
      case 11:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshrq<11>>()};
      case 12:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshrq<12>>()};
      case 13:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshrq<13>>()};
      case 14:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshrq<14>>()};
      case 15:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshrq<15>>()};
      default:
        HYPERVEC_THROW_FMT("Invalid shift %d", shift);
    }
  }
  ...
  simd16uint16_tpl operator<<(const int shift) const {
    switch (shift) {
      ...
      case 1:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshlq<1>>()};
      case 2:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshlq<2>>()};
      case 3:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshlq<3>>()};
      case 4:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshlq<4>>()};
      case 5:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshlq<5>>()};
      case 6:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshlq<6>>()};
      case 7:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshlq<7>>()};
      case 8:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshlq<8>>()};
      case 9:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshlq<9>>()};
      case 10:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshlq<10>>()};
      case 11:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshlq<11>>()};
      case 12:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshlq<12>>()};
      case 13:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshlq<13>>()};
      case 14:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshlq<14>>()};
      case 15:
        return simd16uint16_tpl{
          detail::simdlib::unary_func(data).call<detail::simdlib::vshlq<15>>()};
      default:
        HYPERVEC_THROW_FMT("Invalid shift %d", shift);
    }
  }
  ...
  simd16uint16_tpl operator+(const simd16uint16_tpl& other) const {
    return simd16uint16_tpl{
      detail::simdlib::binary_func(data, other.data).call<&vaddq_u16>()};
  }

  simd16uint16_tpl operator-(const simd16uint16_tpl& other) const {
    return simd16uint16_tpl{
      detail::simdlib::binary_func(data, other.data).call<&vsubq_u16>()};
  }
  ...
  simd16uint16_tpl operator&(const T& other) const {
    return simd16uint16_tpl{
      detail::simdlib::binary_func(data,
  ...
  simd16uint16_tpl operator==(const simd16uint16_tpl& other) const {
    return simd16uint16_tpl{
      detail::simdlib::binary_func(data, other.data).call<&vceqq_u16>()};
  }
  ...
  bool is_same_as(T other) const {
    ...
    const auto equals =
      detail::simdlib::binary_func(data, o).template call<&vceqq_u16>();
  ...
  uint32_t ge_mask(const simd16uint16_tpl& thresh) const {
    const auto input =
      detail::simdlib::binary_func(data, thresh.data).call<&vcgeq_u16>();
  ...
  void accu_min(const simd16uint16_tpl& incoming) {
    data = detail::simdlib::binary_func(incoming.data, data).call<&vminq_u16>();
  }

  void accu_max(const simd16uint16_tpl& incoming) {
    data = detail::simdlib::binary_func(incoming.data, data).call<&vmaxq_u16>();
  }
};
...
inline simd16uint16_tpl<SIMDLevel::ARM_NEON> combine2x2(
  ...
  return simd16uint16_tpl<SIMDLevel::ARM_NEON>{
    uint16x8x2_t{vaddq_u16(a.data.val[0], a.data.val[1]),
...
inline uint32_t cmp_ge32(const simd16uint16_tpl<SIMDLevel::ARM_NEON>& d0,
...
inline uint32_t cmp_le32(const simd16uint16_tpl<SIMDLevel::ARM_NEON>& d0,
                         const simd16uint16_tpl<SIMDLevel::ARM_NEON>& d1,
                         const simd16uint16_tpl<SIMDLevel::ARM_NEON>& thr) {
...
inline void cmplt_min_max_fast(
  ...
  const uint16x8x2_t comparison =
    detail::simdlib::binary_func(candidateValues.data, currentValues.data)
      .call<&vcltq_u16>();

  minValues = min(candidateValues, currentValues);
  minIndices.data =
    uint16x8x2_t{vbslq_u16(comparison.val[0], candidateIndices.data.val[0],
                           currentIndices.data.val[0]),
                 vbslq_u16(comparison.val[1], candidateIndices.data.val[1],
                           currentIndices.data.val[1])};

  maxValues = max(candidateValues, currentValues);
  maxIndices.data =
    uint16x8x2_t{vbslq_u16(comparison.val[0], currentIndices.data.val[0],
                           candidateIndices.data.val[0]),
                 vbslq_u16(comparison.val[1], currentIndices.data.val[1],
...
struct simd32uint8_tpl<SIMDLevel::ARM_NEON> {
  ...
  template <uint8_t _0, uint8_t _1, uint8_t _2, uint8_t _3, uint8_t _4,
            uint8_t _5, uint8_t _6, uint8_t _7, uint8_t _8, uint8_t _9,
            uint8_t _10, uint8_t _11, uint8_t _12, uint8_t _13, uint8_t _14,
            uint8_t _15, uint8_t _16, uint8_t _17, uint8_t _18, uint8_t _19,
            uint8_t _20, uint8_t _21, uint8_t _22, uint8_t _23, uint8_t _24,
            uint8_t _25, uint8_t _26, uint8_t _27, uint8_t _28, uint8_t _29,
            uint8_t _30, uint8_t _31>
  ...
  void bin(char bits[257]) const {
    ...
    store(bytes);
    detail::simdlib::bin(
      const_cast<const char(&)[32]>(reinterpret_cast<char(&)[32]>(bytes)),
      bits);
  }
  ...
  simd32uint8_tpl operator&(const T& other) const {
    return simd32uint8_tpl{detail::simdlib::binary_func(
  ...
  bool is_same_as(T other) const {
    ...
    const auto equals =
      detail::simdlib::binary_func(data, o).template call<&vceqq_u8>();
...
inline simd32uint8_tpl<SIMDLevel::ARM_NEON> uint16_to_uint8_saturate(
  const simd16uint16_tpl<SIMDLevel::ARM_NEON>& a,
  const simd16uint16_tpl<SIMDLevel::ARM_NEON>& b) {
  return simd32uint8_tpl<SIMDLevel::ARM_NEON>{
    uint8x16x2_t{vqmovn_high_u16(vqmovn_u16(a.data.val[0]), b.data.val[0]),
...
inline simd32uint8_tpl<SIMDLevel::ARM_NEON> blendv(
  ...
  const uint8x16x2_t msb_mask = {vtstq_u8(mask.data.val[0], msb),
                                 vtstq_u8(mask.data.val[1], msb)};
...
struct simd8uint32_tpl<SIMDLevel::ARM_NEON> {
  ...
  explicit simd8uint32_tpl(uint32_t x) : data{vdupq_n_u32(x), vdupq_n_u32(x)} {}
  ...
  explicit simd8uint32_tpl(uint32_t u0, uint32_t u1, uint32_t u2, uint32_t u3,
  ...
  simd8uint32_tpl operator+(simd8uint32_tpl other) const {
    return simd8uint32_tpl{
      detail::simdlib::binary_func(data, other.data).call<&vaddq_u32>()};
  }

  simd8uint32_tpl operator-(simd8uint32_tpl other) const {
    return simd8uint32_tpl{
      detail::simdlib::binary_func(data, other.data).call<&vsubq_u32>()};
  }
  ...
  simd8uint32_tpl operator==(simd8uint32_tpl other) const {
    return simd8uint32_tpl{
      detail::simdlib::binary_func(data, other.data).call<&vceqq_u32>()};
  }
  ...
  bool is_same_as(T other) const {
    ...
    const auto equals =
      detail::simdlib::binary_func(data, o).template call<&vceqq_u32>();
    const auto equal = vandq_u32(equals.val[0], equals.val[1]);
    return vminvq_u32(equal) == 0xffffffffu;
  }

  void clear() {
    detail::simdlib::set1(data, static_cast<uint32_t>(0)).call<&vdupq_n_u32>();
  }
  ...
  simd8uint32_tpl unzip() const {
    return simd8uint32_tpl{uint32x4x2_t{vuzp1q_u32(data.val[0], data.val[1]),
...
inline void cmplt_min_max_fast(
  ...
  minValues.data =
    detail::simdlib::binary_func(candidateValues.data, currentValues.data)
      .call<&vminq_u32>();
  minIndices.data =
    uint32x4x2_t{vbslq_u32(comparison.val[0], candidateIndices.data.val[0],
                           currentIndices.data.val[0]),
                 vbslq_u32(comparison.val[1], candidateIndices.data.val[1],
                           currentIndices.data.val[1])};
  ...
  maxValues.data =
    detail::simdlib::binary_func(candidateValues.data, currentValues.data)
      .call<&vmaxq_u32>();
  maxIndices.data =
    uint32x4x2_t{vbslq_u32(comparison.val[0], currentIndices.data.val[0],
                           candidateIndices.data.val[0]),
                 vbslq_u32(comparison.val[1], currentIndices.data.val[1],
                           candidateIndices.data.val[1])};
}
...
struct simd8float32_tpl<SIMDLevel::ARM_NEON> {
  ...
  explicit simd8float32_tpl(float f0, float f1, float f2, float f3, float f4,
  ...
  simd8float32_tpl operator*(const simd8float32_tpl& other) const {
    return simd8float32_tpl{
      detail::simdlib::binary_func(data, other.data).call<&vmulq_f32>()};
  }

  simd8float32_tpl operator+(const simd8float32_tpl& other) const {
    return simd8float32_tpl{
      detail::simdlib::binary_func(data, other.data).call<&vaddq_f32>()};
  }

  simd8float32_tpl operator-(const simd8float32_tpl& other) const {
    return simd8float32_tpl{
      detail::simdlib::binary_func(data, other.data).call<&vsubq_f32>()};
  }
  ...
  bool is_same_as(T other) const {
    ...
    const auto equals = detail::simdlib::binary_func<::uint32x4x2_t>(data, o)
...
inline simd8float32_tpl<SIMDLevel::ARM_NEON> fmadd(
  ...
  return simd8float32_tpl<SIMDLevel::ARM_NEON>{
    float32x4x2_t{vfmaq_f32(c.data.val[0], a.data.val[0], b.data.val[0]),
...
inline void cmplt_and_blend_inplace(
  ...
  lowestValues.data =
    float32x4x2_t{vbslq_f32(comparison.val[0], candidateValues.data.val[0],
                            lowestValues.data.val[0]),
                  vbslq_f32(comparison.val[1], candidateValues.data.val[1],
...
inline void cmplt_min_max_fast(
  ...
  simd8uint32_tpl<SIMDLevel::ARM_NEON>& maxIndices) {
  const uint32x4x2_t comparison = detail::simdlib::binary_func<::uint32x4x2_t>(
