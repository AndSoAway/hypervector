...
HYPERVEC_API extern int bucket_sort_verbose;
 ...
 */
void bucket_sort(size_t nval, const uint64_t* vals, uint64_t nbucket,
                 int64_t* lims, int64_t* perm, int nt = 0);
