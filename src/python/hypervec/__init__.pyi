...
# hypervec Python API type stubs
...
idx_t = int
MetricType = int
kMetricInnerProduct: int
kMetricL2: int
kMetricL1: int
kMetricLinf: int
kMetricLp: int
kMetricCanberra: int
kMetricBrayCurtis: int
kMetricJensenShannon: int
kMetricJaccard: int
kMetricNaNEuclidean: int
kMetricGower: int
...
def GetNumericTypeSize(numeric_type: int) -> int: ...
...
# Version information
HYPERVEC_VERSION_MAJOR: int
HYPERVEC_VERSION_MINOR: int
HYPERVEC_VERSION_PATCH: int
...
class Index:
    ...
    def __init__(self, d: int = 0, metric: MetricType = kMetricL2) -> None: ...
    ...
    @overload
    def AddWithIds(self, x: torch.Tensor, ids: torch.Tensor) -> None: ...
    @overload
    def AddWithIds(
    ...
    def Reset(self) -> None: ...
    def RemoveIds(self, sel: IDSelector) -> int: ...
    @overload
    ...
    def GetDistanceComputer(self) -> DistanceComputer: ...

    # Standalone codec interface with tensor overloads
    def SaCodeSize(self) -> int: ...
    @overload
    def SaEncode(
    ...
    def MergeFrom(self, other_index: Index, add_id: int = 0) -> None: ...
    def CheckCompatibleForMerge(self, other_index: Index) -> None: ...
    @overload
    ...
    @overload
    def PermuteEntries(self, perm: torch.Tensor) -> None: ...
    @overload
    def PermuteEntries(self, perm: npt.NDArray[np.int64]) -> None: ...
...
class IndexFlat(Index):
    def __init__(self, d: int, metric: MetricType = kMetricL2) -> None: ...
    @overload
    def Search(
        self,
        x: torch.Tensor,
    ...
    def GetXb(self) -> npt.NDArray[np.float32]: ...
...
class IndexFlatL2(IndexFlat):
    ...
    def __init__(self, d: int) -> None: ...
    def SyncL2Norms(self) -> None: ...
    def ClearL2Norms(self) -> None: ...
...
class IndexFlat1D(IndexFlatL2):
    ...
    def UpdatePermutation(self) -> None: ...
    def Reset(self) -> None: ...
...
class IndexScalarQuantizer(Index):
    ...
    def __init__(self, d: int, qtype: int, metric: MetricType = kMetricL2) -> None: ...
...
class InvertedLists:
    ...
    def MergeFrom(self, other: InvertedLists, add_id: int = 0) -> None: ...
...
class IndexIVF(Index):
    ...
    def __init__(
        self, quantizer: Index, d: int, nlist: int, metric: MetricType = kMetricL2
    ) -> None: ...
    ...
    def GetCodePacker(self) -> Any: ...  # CodePacker*
    def copy_subset_to(
        self,
        other: IndexIVF,
...
class IndexHNSW(Index):
    ...
    def __init__(self, d: int, M: int, metric: MetricType = kMetricL2) -> None: ...
...
class IndexHNSWPQ(IndexHNSW):
    ...
    def __init__(
        self, d: int, pq: ProductQuantizer, M: int, metric: MetricType = kMetricL2
    ) -> None: ...
...
class IndexHNSWSQ(IndexHNSW):
    ...
    def __init__(
        self, d: int, sq: ScalarQuantizer, M: int, metric: MetricType = kMetricL2
    ) -> None: ...
...
class IndexBinary:
    ...
    def Reset(self) -> None: ...
    @overload
    def RemoveIds(self, x: torch.Tensor) -> int: ...
    @overload
    def RemoveIds(self, x: npt.NDArray[np.int64]) -> int: ...
    @overload
    def RemoveIds(self, sel: IDSelector) -> int: ...
    @overload
    def Assign(self, x: torch.Tensor, k: int = 1) -> torch.Tensor: ...
...
class IndexBinaryIVF(IndexBinary):
    ...
    def replace_invlists(self, invlists: InvertedLists, own: bool = False) -> None: ...
    def get_list_size(self, list_no: int) -> int: ...
    def MergeFrom(self, other: IndexBinaryIVF, add_id: int = 0) -> None: ...
    def CheckCompatibleForMerge(self, other: IndexBinaryIVF) -> None: ...
...
def CheckCompatibleForMerge(index1: Index, index2: Index) -> None: ...
...
class IndexIDMap(Index):
    ...
    def SaCodeSize(self) -> int: ...
    @overload
    def AddSaCodes(self, codes: torch.Tensor, ids: torch.Tensor) -> None: ...
    @overload
    def AddSaCodes(
...
class IndexBinaryIDMap2(IndexBinaryIDMap):
    ...
    def check_consistency(self) -> None: ...
    def construct_rev_map(self) -> None: ...
    def MergeFrom(self, other_index: IndexBinary, add_id: int = 0) -> None: ...
    def RemoveIds(self, sel: IDSelector) -> int: ...
    @overload
    def Reconstruct(self, key: int) -> torch.Tensor: ...
    @overload
...
class IndexNSG(Index):
    nsg: Any  # hypervec::nsg::Graph
    base_index: Index
    GK: int
    build_type: int
    verbose: bool

    def __init__(self, d: int, R: int, metric: MetricType = kMetricL2) -> None: ...
    @overload
...
class IndexNNDescent(Index):
    nndescent: Any  # hypervec::nndescent::NNDescent
    storage: Index
    own_fields: bool

    def __init__(self, d: int, K: int, metric: MetricType = kMetricL2) -> None: ...
