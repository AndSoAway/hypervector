...
try:
    from .examples_data import find_index_example, supported_index_examples
...
class HypervecServerEngine:
    ...
    def supported_index_examples(self) -> list[dict[str, Any]]:
        return supported_index_examples(self.hypervec)

    def get_index_example(self, index_type: str) -> dict[str, Any] | None:
        return find_index_example(self.hypervec, index_type)
