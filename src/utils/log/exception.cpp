...
HypervecException::HypervecException(const std::string& m) : msg(m) {}

HypervecException::HypervecException(const std::string& m, const char* funcName,
...
const char* HypervecException::what() const noexcept {
  return msg.c_str();
}
