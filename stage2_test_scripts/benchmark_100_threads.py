...
def worker(host, collection_name, query_vectors, query_indices, ef_search, k=10):
    """单个线程执行多次查询"""
...
def run_benchmark_for_ef(host, collection_name, queries, groundtruth, ef_search,
...
def main():
    ...
    parser.add_argument('--groundtruth', default='/root/vector/data/wiki_all_1M/groundtruth.1M.neighbors.ibin')
